...
//     alert(`${userNumber} is a invalid number`)
// }
...
// let box1 = parseInt(prompt("enter a number"))
// let box2 = parseInt(prompt("enter a number"))

// if (box1 > box2){
//     alert(`${box1} is greater than ${box2}`)
// }
//   else if(box1=== box2){
//     alert(`${box2} is equal to ${box1}`)
//   }
//  else{
//     alert(`${box2} is greater than ${box1}`)
// }
